...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_module', type=str, default="", help="path for target network weight")
    ...
    config["load_module"] = args.load_module
    config["val_method"] = args.validation_method
    ...
    config["loss"] = {"trade_off":args.tradeoff}
    ...
    if config["dataset"] == "office":
        if ("amazon" in args.s_dset_path and "webcam" in args.t_dset_path) or \
           ...
           ("dslr" in args.s_dset_path and "amazon" in args.t_dset_path):
            config["optimizer"]["lr_param"]["lr"] = args.initlr # 0.001 # optimal parameters
        elif ("amazon" in args.s_dset_path and "dslr" in args.t_dset_path) or \
             ("dslr" in args.s_dset_path and "webcam" in args.t_dset_path):
            config["optimizer"]["lr_param"]["lr"] = args.initlr # 0.0003 # optimal parameters
